...
This is a modified version of the MaxPRE repository, equipped to perform MaxSAT preprocessing for the distributed solver MallobMax.
...
<hr/>
The original README of MaxPRE follows.
<hr/>
